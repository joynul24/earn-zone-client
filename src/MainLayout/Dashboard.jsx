...
//           <div className="flex items-center mr-[5px] p-6">
//             <img className='w-[30px]' src={dashboardLogo} alt="" />
...
//                 </NavLink>
//               </li>
//               {/* অন্যান্য ন্যাভলিংক এখানে যোগ করুন */}
//             </ul>
//           </nav>
//         </aside>
...
//               Welcome to the earnZone Dashboard
//             </h2>
//             {/* অন্যান্য হেডার আইটেম যেমন প্রোফাইল, নোটিফিকেশন ইত্যাদি */}
//           </header>
